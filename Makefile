...
gnomeconf:
	...
	dconf write /org/gnome/shell/favorite-apps "['org.gnome.Nautilus.desktop', 'roxterm.desktop', 'firefox.desktop', 'google-chrome.desktop', 'mousepad.desktop', 'keepassx2.desktop']"
